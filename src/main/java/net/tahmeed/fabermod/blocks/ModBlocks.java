package net.tahmeed.fabermod.blocks;
...
import net.tahmeed.fabermod.blocks.custom.SoundBlock;
import net.tahmeed.fabermod.blocks.custom.StrawberryCropBlock;
...
public class ModBlocks {
    public static final DeferredRegister<Block> BLOCKS =
            DeferredRegister.create(ForgeRegistries.BLOCKS, FaberMod.MOD_ID);
    ...
    public static final RegistryObject<Block> AMEDYRE_BLOCK = registerBlock("amedyre_block",
            () -> new Block(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK).sound(SoundType.AMETHYST)));
    public static final RegistryObject<Block> RAW_AMEDYRE_BLOCK = registerBlock("raw_amedyre_block",
            () -> new Block(BlockBehaviour.Properties.copy(Blocks.IRON_ORE).sound(SoundType.AMETHYST)));
