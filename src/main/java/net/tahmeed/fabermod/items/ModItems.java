...
import net.tahmeed.fabermod.items.custom.DayLightSaverItem;
import net.tahmeed.fabermod.items.custom.FuelItem;
import net.tahmeed.fabermod.items.custom.MetalDetectorItem;
import net.tahmeed.fabermod.items.custom.ModArmorItem;
...
public class ModItems {
    ...
    public static final RegistryObject<Item> DAYLIGHT_SAVER = ITEMS.register("daylight_saver",
            ()-> new DayLightSaverItem(new Item.Properties().durability(50)));
